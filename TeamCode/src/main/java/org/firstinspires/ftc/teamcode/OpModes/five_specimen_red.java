...
public class five_specimen_red extends intothedeep_auto{
    ...
    public void init(){
        ...
        splineToOutput2 = drive.actionBuilder(new Pose2d(-20, 52, Math.toRadians(145)))
                .setTangent(270)
                .splineToLinearHeading(new Pose2d(-6, 38, Math.toRadians(120)), Math.toRadians(280))
                .afterTime(0.1, vertslides(900, false));
        stOutput2 = splineToOutput2.build();
        moveforward = drive.actionBuilder(new Pose2d(-6, 38, Math.toRadians(120)))
        ...
        splineToOutput3 = drive.actionBuilder(new Pose2d(-20, 52, Math.toRadians(145)))
                .setTangent(270)
                .splineToLinearHeading(new Pose2d(-4, 38, Math.toRadians(120)), Math.toRadians(280))
                .afterTime(0.1, vertslides(900, false));
        stOutput3 = splineToOutput3.build();
        moveforward2 = drive.actionBuilder(new Pose2d(-4, 38, Math.toRadians(120)))
