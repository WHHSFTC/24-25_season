...
public class foursample_red extends intothedeep_auto{
    ...
    private final Pose sample1Pos = new Pose(15.7, 123.7, Math.toRadians(350));
    private final Pose sample2Pos = new Pose(15.6, 126.2, Math.toRadians(5));
    private final Pose sample3Pos = new Pose(16.9, 129.7, Math.toRadians(15));
